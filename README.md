...
## 👷🏻‍♂️ Side Prejects
 ...
 - [OTPilot](https://chromewebstore.google.com/detail/otpilot/mbfpjhjhcmgcchnnnnjcdblkbjifgjpk?authuser=0&hl=en-GB&pli=1) OTPilot is a Chrome extension that turns any site's 2FA setup page into a one-click add — no QR scanner, no secret keys, no phone. When you visit a login page it's configured for, it fills the TOTP code and submits the form automatically. Everything is stored locally, protected by a master password, and never sent to any server. 
